...
// export const changeStyle=function(ele){
//   ele.style.opacity=1;
// }
// export const moveUpInInterval=function(point=0,ele){
...
//    if(Math.abs(parseInt(ele.style.marginTop))>714){
...
//     backSpace();
//   }
//   if(e.key!=="Backspace"||!e.key=='Shift'||!e.key=='CapsLock'||
//   !e.key=='Tab'||!e.key=='Control'||!e.key=='Meta'
//   ||!e.key=='Alt'||!e.key=='NumLock'||!e.key=='AltGraph'){
//     console.log(e.key);
//     t.textContent+=e.key;
//   }
...
//   let indexEnterCount=0;
//   while(indexEnter[indexEnterCount]!=undefined){
//     indexEnter.pop();
//     indexEnterCount++;
//   }
//   scoreBoard.score=0;
...
//    removeQuitModal();
//    let n=0;
//    while(intervalIdContainer[n]!=undefined){
//     intervalIdContainer.pop();
//     n++;
//    }
